...
Hello friends! Development on **PowershAI** has slowed down a bit, but it’s definitely not dead.
Due to other priorities, I haven’t been able to move as fast as I’d like, but I’m still keeping an eye on new AI updates and opening issues so that, when I have time, I can continue working on it. After all, this project is a great way for me to learn more about AI!
...
This beta version will not include tests and may contain more severe bugs than the regular release.
The goal is to share changes faster for early testing, since running the test suite can be a bottleneck—but one that’s important for ensuring quality.
So, the beta version should be used with caution.
