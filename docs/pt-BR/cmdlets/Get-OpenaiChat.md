...
```
Get-OpenaiChat [[-prompt] <Object>] [[-temperature] <Object>] [[-model] <Object>] [[-MaxTokens] <Object>]
 [[-ResponseFormat] <Object>] [[-Functions] <Object>] [[-RawParams] <Object>] [[-StreamCallback] <Object>]
 [[-endpoint] <Object>] [<CommonParameters>]
```
...
### -ResponseFormat
{{ Fill ResponseFormat Description }}
