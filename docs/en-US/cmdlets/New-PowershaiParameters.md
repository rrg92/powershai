...
When using tool calling, this parameter limits how many sequential tools that resulted in errors can be called.  
...
This parameter is a script block that must return a string with the context to be injected into the prompt!  
The parameters of the script block are:
...
If null, a default will be generated. Check the cmdlet Send-PowershaiChat for details
